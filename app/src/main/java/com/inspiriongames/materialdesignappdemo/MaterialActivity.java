...
public class MaterialActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCollapsingToolbarLayout.setTitle(getResources().getString(R.string.title_activity_material));
    }
...
class YourPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        MaterialActivity.MyFragment myFragment = MaterialActivity.MyFragment.newInstance(position);
        return myFragment;
    }
